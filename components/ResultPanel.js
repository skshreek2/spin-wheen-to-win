      ...
      >
        ...
        >
          {resultLayout.lines.map((line, index) => {
            ...
            const BLAST_SCALE_END = 1.8;
            const BLAST_OPACITY_START = 1;
            const BLAST_OPACITY_END = 0.05;
            ...
            const baseSwellY =
              Math.cos(resultWavePhase * 1.05 + y * 0.012) * 0.55;
            ...
            return (
              <div
                ...
                style={{
                  ...
                  transform: `translate3d(${safeX}px, ${yOffset}px, 0) scale(${blastScale})`,
                  opacity: 1,
                  filter:
                    blastPhase > 1
